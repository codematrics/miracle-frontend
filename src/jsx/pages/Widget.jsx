...
const Widget = () => {
  return (
    <Fragment>
      {/* <Ext /> */}
      <PageTitle activeMenu="Statistics" motherMenu="Widget" pageContent="Widget" />
                ...
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Alfie Mason <small className="text-muted">29 July 2022</small>
                        </h5>
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Jacob Tucker <small className="text-muted">29 July 2022</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Jack Ronan <small className="text-muted">29 July 2022</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Noah Baldon <small className="text-muted">29 July 2022</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Oscar Weston <small className="text-muted">29 July 2022</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        ...
                        <small className="text-muted">29 July 2022 - 02:26 PM</small>
                      </div>
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle variant="primary light" className=" i-false p-0 sharp">
                          <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
          ...
          <div className="card active_users">
            ...
            <div className="card-body pt-0">
              <div className="list-group-flush mt-4">
                <div className="list-group-item bg-transparent border-0 border-bottom d-flex justify-content-between px-0 py-1">
