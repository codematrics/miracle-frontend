  ...
  return (
    <>
      <div className="page-titles">
        ...
        <Link to={'#'} className="text-primary fs-13" onClick={() => handleShow()}>
          + Add Task
        </Link>
      </div>
      <Offcanvas
            ...
            <form onClick={e => handleDesk(e)}>
              <div className="row">
                <div className="col-xl-6 mb-3">
                  <label htmlFor="exampleFormControlInputfirst" className="form-label">
                ...
                <div className="col-xl-6 mb-3">
                  ...
                  <Select options={options} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label htmlFor="exampleFormControlInputthree" className="form-label">
                ...
                <div className="col-xl-6 mb-3">
                  <label htmlFor="exampleFormControlInputfour" className="form-label">
                ...
                <div className="col-xl-6 mb-3">
                  ...
                  <Select options={options2} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
                    priority<span className="text-danger">*</span>
                  </label>
                  <Select options={options3} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
                    Category<span className="text-danger">*</span>
                  </label>
                  <Select options={options4} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
                    Permission<span className="text-danger">*</span>
                  </label>
                  <Select options={options5} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
                    Deadline add<span className="text-danger">*</span>
                  </label>
                  <Select options={options6} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
                    Assigned to<span className="text-danger">*</span>
                  </label>
                  <Select options={options7} isSearchable={false} className="custom-react-select" />
                </div>
                <div className="col-xl-6 mb-3">
                  <label className="form-label">
              ...
              <div>
                ...
                <Link to={'#'} className="btn btn-danger light ms-1" onClick={() => handleClose()}>
                  Cancel
                </Link>
              </div>
            </form>
