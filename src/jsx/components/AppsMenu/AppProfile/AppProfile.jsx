...
const AppProfile = () => {
  ...
  return (
    <Fragment>
      <PageTitle pageContent="Profile" motherMenu="App" activeMenu={'Profile'} />
      <div className="row">
                      ...
                      <Tab.Pane id="my-posts" eventKey="Posts">
                        <div className="my-post-content pt-3">
                          ...
                          <div className="profile-uoloaded-post pb-3">
                            ...
                            <button className="btn btn-primary me-2" onClick={() => setLike(!like)}>
                              <span className="me-2">
                                {like ? (
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <textarea
              ...
              defaultValue={''}
            />
            <Link className="btn btn-primary  mt-1" to="/app-profile">
              Post
            </Link>
          </div>
        </div>
