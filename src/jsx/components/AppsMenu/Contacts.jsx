...
const Contacts = () => {
  ...
  const custom = useRef();
  const [data, setData] = useState(document.querySelectorAll('#contacts-tbl_wrapper tbody tr'));
  const sort = 13;
  ...
  return (
    <>
                      ...
                      <tbody>
                        {tableData.map((item, index) => (
                          <tr key={index}>
                            <td className="sorting_2">
                              <div className="form-check11custom-checkbox">
                                <input
                                  ...
                                  id={`contact${index + 101}`}
                                  required=""
                                  onClick={() => checkboxFun()}
                                />
                                <label
                                  className="form-check-label"
                                  htmlFor={`contact${index + 101}`}
                                ></label>
                              </div>
                            </td>
                            <td>
                            ...
                            <td className="pe-0">
                              <span
                                className={`badge border-0 badge-sm badge-${
                                  item.tags === 'Important'
                                    ? 'secondary'
                                    : item.tags === 'Customer'
                                      ? 'success'
                            ...
                            <td className="pe-0">{item.contact}</td>
      ...
      <EmployeeOffcanvas ref={addcontact} Title="Add Contacts" />
      <InviteCustomer ref={custom} Title="Invite Customer" />
    </>
  );
};
