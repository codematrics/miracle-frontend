...
const Read = () => {
  ...
  return (
    <Fragment>
      <PageTitle pageContent="Read" activeMenu="Read" motherMenu="Email" />
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className={`col-lg-4 email-left-body ${openMailBar ? 'active' : ' '}`}>
                      ...
                      <div className="read-content">
                        <div className="media pt-3">
                          ...
                          <div className="media-body me-2">
                            ...
                            <p className="mb-0">20 September 2024</p>
                          </div>
                          <Link to="/email-read" className="btn btn-primary px-3 light">
                            <i className="fa fa-reply"></i>
                          </Link>
                          <Link to="/email-read" className="btn btn-primary px-3 light ms-1">
                        ...
                        <div className="media mb-2 mt-3">
                          <div className="media-body">
                            <span className="pull-right">08:23 AM</span>
