        ...
        <Modal.Body>
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="form-group">
                <label className="text-black font-w500">
                  Ref By <span className="text-danger">*</span>
                </label>
                <select
                  id="refby"
                  name="refby"
            ...
            <div className="col-md-3">
              <div className="form-group">
                <label className="text-black font-w500">
                  Visiting Doctor <span className="text-danger">*</span>
                </label>
                <select
                  id="visitingdoctor"
                  name="visitingdoctor"
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="form-group">
                <label className="text-black">
                  Medico Legal(MLC) <span className="text-danger">*</span>
                </label>
            ...
            <div className="col-md-3">
              <div className="form-group">
                <label className="text-black font-w500">
                  Mediclaim <span className="text-danger">*</span>
                </label>
                <select
                  id="mediclaim_type"
                  name="mediclaim_type"
