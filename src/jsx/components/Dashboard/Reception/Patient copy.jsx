...
const Patient = () => {
  ...
  const [data, setData] = useState(document.querySelectorAll('#patient_list tbody tr'));
  const sort = 10;
  ...
  const prescriptionPatient = {
    id: '1',
    patientName: 'Bhagwati Lal Patidar',
    fathername: 'Bheru Lal Patidar',
    UHID: 'MH1000202502101',
    mobileno: '9770014840',
    age: '35 Yr',
  ...
  const PrescriptionContent = () => (
    <div className="prescription-container text-black" id="printable-prescription">
      {/* Hospital Header */}
      <div className="hospital-header">
        <img src={headerLogo} alt="Hospital Logo" style={{ maxWidth: '100%', height: 'auto' }} />
      </div>
      {/* Patient Visit Data */}
      <div className="text-black">
        <div className="row">
            ...
            <table className="table table-bordered text-black table-responsive-sm patient-info">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {prescriptionData?.age} / {prescriptionData?.gender}
                  </td>
                </tr>
                <tr>
                  <td>
      ...
      <div className="signature text-black">
        ...
        <br />
        <span className="doctor-degree">{prescriptionData?.specialization}</span>
        <br />
    ...
    <>
        ...
        <div>
          <ButtonGroup>
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item to="#" onClick={() => setOpenAddPatientModal(true)}>
                  {' '}
                  New Patient
                </Dropdown.Item>
                      ...
                      <td>
                        <Dropdown className="ms-auto c-pointer text-end">
                          ...
                          <Dropdown.Menu className="dropdown-menu-end" align="end">
                            ...
                            <Dropdown.Item
                              disabled={loading}
                              onClick={() => fetchPrescriptionData(item.patientid)}
                            >
                              {' '}
                              {loading ? 'Loading...' : 'Print Prescription'}{' '}
                            </Dropdown.Item>
      ...
      >
        <Modal.Header>
          ...
          <Button variant="" className="btn-close" onClick={() => setVisitModal(false)}></Button>
        </Modal.Header>
        <Modal.Body>
          <div className="row">
        ...
        <Modal.Footer>
          <Button onClick={() => setVisitModal(false)} variant="dark btn-sm">
            Close
          </Button>
      ...
      >
        ...
        <Modal.Footer>
          <Button onClick={() => setPrescriptionModal(false)} variant="dark btn-sm">
            Close
          </Button>
