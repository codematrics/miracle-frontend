...
import AbilityPieChart from './Element/AbilityPieChart';
import PatientPieChart from './Element/PatientPieChart';
              ...
              <div className="card doctor-details-card">
                <div className="bg-img-bx">
                  ...
                  <Link to={'/doctor'} className="btn btn-primary">
                    <i className="las la-stethoscope me-3 scale5"></i>Dentist Specialist
                  </Link>
                </div>
                    ...
                    <div className="card-info d-flex align-items-start">
                      <div className="me-auto pe-3">
                        ...
                        <span className="date">
                          ...
                          Join on 28 October 2023, 12:45 AM
                        </span>
                      </div>
                    ...
                    <div className="media p-3 border border-bottom-0" key={ind}>
                      ...
                      <div className="media-body row align-items-center">
                        <div className="col-md-8 mb-md-0 mb-3">
                          <h4>
                            <Link to={'/reviews'} className="text-black fs-20">
                              {item.title}
                            </Link>
                          </h4>
                          {ind === 0 ? (
                            <p className="fs-14">
                              Hospital & staff were extremely warm & quick in getting me start with
                              the procedures
                            </p>
                          ) : ind === 1 ? (
                            <p className="fs-14">
                              When I came with my mother, I was very nervous. But after entering
                              here I felt warmed with smiling
                            </p>
                          ) : (
                            <p className="fs-14">
                              Thanks for all the services, no doubt it is the best hospital. My
                              kidney, BP, diabetes problem
                            </p>
                          )}
                          <Link to={'#'} className="btn btn-xxs btn-outline-primary me-2">
                            EXCELENT
                          </Link>{' '}
                          <Link to={'#'} className="btn btn-xxs btn-outline-primary">
                            GREAT SERVICE
                          </Link>
                        </div>
                        <div className="col-md-4 text-md-center">
                          <h3 className="fs-24 text-primary font-w600 mb-md-2 mb-0">
                            {item.rating}
                          </h3>
                          <ul className="stars justify-content-md-center">
                            ...
                            <li>
                              <i className="las la-star text-dark"></i>
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div className="card appointment-schedule">
                ...
                <div className="card-body pt-2">
                  <div className="row">
                    ...
                    <div
                      className="height380 col-xl-12 col-xxl-6 col-md-6 col-sm-5 dz-scroll"
                    ...
                    >
                      {appointmentBlog.map((item, index) => (
                        <div className="d-flex pb-3 border-bottom mb-3 align-items-end" key={index}>
                          <div className="me-auto">
                            <p className="text-black font-w600 mb-2">
                              {item.day}, {item.date}
                            </p>
                            <ul>
                              <li>
                                <i className="las la-clock"></i>09:00 - 10:30 AM
                              </li>
                              <li>
                                <i className="las la-user"></i>Dr. Samantha
                              </li>
                            </ul>
                          </div>
            ...
            <div className="col-xl-12 col-xxl-4">
              <div className="card patient-list">
                ...
                <div className="card-body">
                  {listBlog.map((item, ind) => (
                    <div className="d-flex mb-4" key={ind}>
                      ...
                      <div>
                        <h5 className="mb-1">
                          <Link to={'/patient'} className="fs-18 text-black">
                            {item.title}
                          </Link>
                        </h5>
                ...
                <div className="card-footer pt-0 border-0">
                  <Link to={'/patient'} className="btn d-block btn-outline-primary">
                    + Assign New Patient
                  </Link>
                </div>
              </div>
