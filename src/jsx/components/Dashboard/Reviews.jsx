...
const cardBlog = [
  {
    ...
    name: 'Glee Smiley',
    subtitle: 'Diabetes',
    para: 'When I came with my mother, I was very nervous. But after entering here I felt warmed with smiling',
  },
  {
    image: IMAGES.Avatar2,
    name: 'Alexa Keev',
    subtitle: 'Dental Care',
    para: 'Thanks for all the services, no doubt it is the best hospital. My kidney, BP, diabetes problem',
  },
  {
    image: IMAGES.Avatar3,
    name: 'Ivankov',
    subtitle: 'Cold & Flu',
    para: 'I am very much glad to note my feedback and grateful. Thanks to Dr. Chibber and assistants. I got very good guidelines for my patient.',
  },
  {
  ...
  },
  {
    ...
    name: 'Kevin Heirn',
    subtitle: 'Dental Care',
    para: 'It was never a feeling as if I was in a hospital. I got the best care. The response of each staff, right from security (screening), housekeeping, admission staff, nurses, trainee doctor, Doctor was excellent. ',
  },
];
