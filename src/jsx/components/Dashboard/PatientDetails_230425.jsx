                ...
                <div className="title text-black">
                  <div className="row">
                    ...
                    <div className="col-md-5 col-sm-12">
                      ...
                      <h5>
                        {patientPreviousVisit?.patientName} {patientPreviousVisit?.relation}{' '}
                        {patientPreviousVisit?.fathername}
                      </h5>
                    </div>
                    ...
                    <div className="col-md-2 col-sm-6">
                      <label>Age/Sex</label>
                      <h5>
                        {patientPreviousVisit?.age} / {patientPreviousVisit?.gender}
                      </h5>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8 col-sm-12">
                    {patientPreviousVisit?.medications.map((row, index) => (
                      <span className="text-black fs-6" key={index}>
                        {row.medType} {row.medName} {row.route} {row.dosage} {row.frequency}{' '}
                        {row.duration} {row.remark}
                      </span>
                    ))}
                  </div>
                </div>
