...
import ServiceTypeCreateAndUpdate from './ServiceTypeCreateAndUpdate';

const ServiceTypeListing = () => {
  ...
  const handleDelete = id => {
    serviceTypeAPIService
      ...
      .then(response => {
        ...
        serviceTypeAPIService.getAll(pagination.page).then(res => {
    ...
    <>
      <div className="form-head align-items-center d-flex mb-sm-4 mb-3">
        <div className="me-auto">
          <h2 className="text-black font-w600">Service Type Management</h2>
        </div>
        <div>
          <ButtonGroup>
            <Dropdown>
...
export default ServiceTypeListing;
