  ...
  return (
    <>
      <div className="form-head align-items-center d-flex mb-sm-4 mb-3">
        ...
        <div>
          <Link to={'#'} className="btn btn-primary me-3" onClick={() => setOpenModal(true)}>
            + New Doctor
          </Link>
          <Link to={'/'} className="btn btn-outline-primary">
            <i className="las la-calendar-plus scale5 me-3" />
            Filter Date
          </Link>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-xl-12">
          <div className="table-responsive card-table">
            <div id="doctor_list" className="dataTables_wrapper no-footer">
              <table
                id="example5"
                ...
                <tbody>
                  {tableData.map((item, ind) => (
                    <tr key={ind}>
                      <td className="doctor_checkbox">
                        <div className="form-check custom-checkbox">
                          <input
                            type="checkbox"
                            className="form-check-input"
                            id={`doctorinput${ind + 5}`}
                            required=""
                            onClick={() => chackboxFun()}
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`doctorinput${ind + 5}`}
                          ></label>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span className="text-nowrap">#P-00012</span>
                      </td>
                      ...
                      <td>
                        {ind % 2 === 1 ? (
                          <Link to={'#'} className="btn btn-primary text-nowrap btn-sm light">
                            5 Appointment
                          </Link>
                        ) : (
                          <Link to={'#'} className="btn btn-outline-dark text-nowrap btn-sm">
                            No Schedule
                          </Link>
                        )}
                      </td>
