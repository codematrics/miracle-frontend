    ...
    <>
      <div className="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div className="me-auto">
          <h2 className="text-black font-w600">Task</h2>
          <p className="mb-0">Hospital Admin Dashboard Template</p>
        </div>
        <Link to={'#'} className="btn btn-outline-primary" onClick={() => setPostModal(true)}>
          <i className="las la-cog scale5 me-3" />
          New Task
        </Link>
      </div>
        ...
        <div className="" role="document">
          <div className="">
            <form>
              ...
              <div className="modal-footer">
                <button type="submit" className="btn btn-primary" onClick={handleEditFormSubmit}>
                  Save
                </button>
                <button
                  type="button"
              ...
              <div className="card-header align-items-start">
                <div>
                  ...
                  <div className="text-dark fs-14 text-nowrap">
                    <i className="fas fa-calendar me-3" />
                ...
                <Dropdown className="">
                  ...
                  <Dropdown.Menu align="end" className="dropdown-menu-right">
                    <Dropdown.Item onClick={event => handleEditClick(event, contact)}>
                      Edit
                    </Dropdown.Item>
                    <Dropdown.Item
