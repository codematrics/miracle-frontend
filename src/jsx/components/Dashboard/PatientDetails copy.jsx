                  ...
                  <div className="d-sm-flex mb-3">
                    <div className="img-card mb-sm-0 mb-3">
                      ...
                      <div className="info d-flex align-items-center p-md-3 p-2 bg-primary">
                        <svg
                          className="me-3 d-sm-inline-block d-none"
                          width="30"
                          height="30"
                          viewBox="0 0 30 30"
                          fill="none"
                    ...
                    <div className="card-info d-flex align-items-start">
                      <div className="me-auto pe-3">
                        ...
                        <span className="date">
                          ...
                          Join on 21 August 2020, 12:45 AM
                        </span>
                      </div>
                  ...
                  <div className="row">
                      ...
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="fs-18 mb-0 text-black">
                            ...
                            <strong className="d-block">CADGE 94107</strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-sm-5">
                      <div className="map-bx">
                        ...
                        <Link to={'#'} className="btn btn-sm btn-primary p-1 fs-12">
                          View in Fullscreen
                        </Link>
            ...
            <div className="col-xl-12 col-xxl-4 col-lg-5">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-6">
                      <Link to={'#'} className="btn btn-outline-dark mb-2 btn-sm d-block">
                        Unassign
                      </Link>
                    </div>
                    <div className="col-6">
                      <Link to={'#'} className="btn btn-primary light mb-2 btn-sm d-block">
                        Check
                      </Link>
                    </div>
                  </div>
